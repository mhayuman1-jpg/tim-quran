...
// Daftar 114 surah Al-Quran untuk dropdown
export const SURAH_ALQURAN_LIST: string[] = [
  'Al Fatihah', 'Al Baqarah', 'Ali Imran', 'An Nisa', 'Al Maidah',
  'Al An\'am', 'Al A\'raf', 'Al Anfal', 'At Taubah', 'Yunus',
  'Hud', 'Yusuf', 'Ar Ra\'d', 'Ibrahim', 'Al Hijr',
  'An Nahl', 'Al Isra', 'Al Kahf', 'Maryam', 'Thaha',
  ...
  'At Tarikh', 'Al A\'la', 'Al Ghashiyah', 'Al Fajr', 'Al Balad',
  'Ash Shams', 'Al Layl', 'Ad Duha', 'Ash Sharh', 'At Tin',
  'Al Alaq', 'Al Qadr', 'Al Bayyinah', 'Az Zalzalah', 'Al Adiyat',
  'Al Qari\'ah', 'At Takathur', 'Al Asr', 'Al Humazah', 'Al Fil',
  'Quraysh', 'Al Ma\'un', 'Al Kautsar', 'Al Kafirun', 'An Nasr',
  'Al Lahab', 'Al Ikhlas', 'Al Falaq', 'An Naas',
];

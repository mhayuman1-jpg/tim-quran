// Layout untuk halaman artikel — navbar + footer publik
...
async function getProfil() {
  try {
    ...
    if (error) {
      console.error('[ArtikelLayout] Supabase error:', error.message);
      return null;
    }

    return data ?? null;
  } catch (error) {
    console.error('[ArtikelLayout] Fetch error:', error);
    return null;
  }
}

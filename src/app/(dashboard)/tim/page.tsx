        ...
        <form onSubmit={handleAddSubmit} className="space-y-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <select
              ...
              disabled={addLoading}
              className="w-full rounded-lg border-slate-300 bg-white px-3 py-2 text-sm text-slate-800 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500"
            >
